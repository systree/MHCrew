        ...
        <section>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 10, marginTop: 8 }}>
            ...
            <AdminNavCard
              ...
              description="See where your active drivers are based on their last job status update"
              icon={
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            ...
            />
            <AdminNavCard
              to="/admin/billing-rules"
              title="Billing Rules"
              description="Configure job-type billing helpers: door-to-door callout, deposit schedules"
              icon={
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            ...
            <AdminNavCard
              to="/admin/activity"
              title="Activity Log"
              description="Audit trail of all critical actions across crew and admins"
              icon={
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                  <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z" />
                  <polyline points="14 2 14 8 20 8" />
